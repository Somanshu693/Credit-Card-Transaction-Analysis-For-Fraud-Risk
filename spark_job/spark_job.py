...
json_file_path = 'gs://credit-card-risk-analysis/transactions/transactions_*.json'

# Define BigQuery Dataset & Table Names
BQ_PROJECT_ID = "symbolic-path-463418-q4"
...
# Joining Transactions with Cardholders Data
...
# writeMethod = "direct" suitable for writing data in batches. For real-time streaming, use "indirect"
...
print("Credit Card Transactions Processing Completed!")